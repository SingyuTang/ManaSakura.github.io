...
bperp_filepath=r'C:\Users\tang xingyou\PycharmProjects\InSAR_plot\bperb_data\sbas\bj2021\bperp_file.txt'#bperp_file文件路径，需改名为txt文件
bperb_pic_savepath=r'C:\Users\tang xingyou\PycharmProjects\InSAR_plot\bperb_data\sbas\bj2021\sbas_bj2018.jpg'#生成的时空基线图保存路径
pic_title= '20210111-20210920时空基线分布图'#自定义标题
xtick_step=5#x轴刻度线两相邻的的影像日期间隔，值越大刻度线越稀
filetype='sbas'#可选择sbas或者‘ps’
